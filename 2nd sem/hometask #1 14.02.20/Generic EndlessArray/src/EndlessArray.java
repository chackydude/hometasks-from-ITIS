...
/**
 * Class of "everlasting" array with generics
...
public class EndlessArray <T> {
     ...
     * @param array
     */
    public EndlessArray(int amountOfElements, int len, T[] array) {
    ...
    public int showIndexOf(T num, int startFrom) {
        int index = -1;
